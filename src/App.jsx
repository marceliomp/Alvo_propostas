...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#04121c] via-[#082b3f] to-[#04121c] text-white/85">
      <header className="sticky top-0 z-40 backdrop-blur border-b border-white/10 bg-[#041d2a]/80">
          ...
          <div className="flex items-center gap-2">
            ...
            {step === "resultado" ? (
              <>
                ...
                <button
                  onClick={savePDF}
                  className="px-3 py-2 rounded-2xl bg-[#0f6a60] hover:bg-[#148374] text-white text-sm font-semibold shadow-lg transition"
                >
                  Baixar PDF
                </button>
              </>
        ...
        <main className="mx-auto max-w-7xl p-6 space-y-6 text-slate-900">
          ...
          <Card title="4) Fluxo de Pagamento (nominal)">
              ...
              <div className="rounded-xl border p-3 bg-slate-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 items-end">
                  <label className="block">
                    ...
                    <select
                      className="w-full px-3 py-2 rounded-xl border bg-white focus:outline-none focus:ring-2 focus:ring-[#0f6a60]"
            ...
            <div className="bg-white border rounded-2xl p-4 shadow-sm text-sm mt-4">
              <p className="font-semibold text-[#0c4c45] mb-2">Resumo</p>
              ...
              <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="rounded-xl bg-[#e4f2ef] border border-[#a8d5ca] p-3">
                  <div className="font-semibold text-[#0c4c45]">{saldoTitle}</div>
                  <div>
                    <strong className="text-[#0f6a60]">{brl(valores.saldoACompor)}</strong>
                  </div>
                  <div className="text-[11px] text-[#0f6a60]/80 mt-1 space-y-1">
            ...
            <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-full text-xs font-medium border transition ${
                          item.highlight
                            ? "border-[#5aa393] bg-[#e4f2ef] text-[#0f6a60]"
                            : "border-slate-200 text-gray-500 hover:border-[#a8d5ca] hover:text-[#0f6a60]"
                        }`}
                      >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 shadow-sm focus:border-[#5aa393] focus:outline-none focus:ring-2 focus:ring-[#d3e9e4]"
                      />
                    </div>
                    <div className="space-y-2">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="px-4 py-2 rounded-2xl border border-[#5aa393] bg-[#e4f2ef] text-sm font-semibold text-[#0f6a60] hover:bg-[#d3e9e4] transition disabled:opacity-50"
            ...
            <section className="page bg-white/95 border border-slate-200 rounded-3xl shadow-xl p-10 space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="rounded-2xl border bg-white p-4 space-y-2 text-sm shadow-sm">
                  ...
                  <div className="flex justify-between text-[#0f6a60] font-semibold">
                  ...
                  {data.arquivoOriginal && (
                    <div className="rounded-2xl border bg-slate-50 p-4 flex flex-wrap items-center justify-between gap-3 text-sm shadow-sm">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="px-4 py-2 rounded-full border bg-white text-xs font-semibold text-[#0f6a60] hover:bg-[#e4f2ef] transition"
                      >
                        Abrir arquivo
                      </a>
                    </div>
            ...
            <section className="page bg-white/95 border border-slate-200 rounded-3xl shadow-xl p-10 space-y-5">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-full border text-xs font-medium text-[#0f6a60] bg-[#e4f2ef] hover:bg-[#d3e9e4] transition"
                  type="button"
              ...
              <div className="pt-4 border-t border-dashed border-slate-200 space-y-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  <div className="bg-[#e4f2ef] border border-[#a8d5ca] rounded-2xl p-4 text-[13px] shadow-sm space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-semibold text-[#083a34]">Cenário 1 — Revenda</h4>
                      <span className="text-xs text-[#0f6a60]">Prazo: {data.prazoObraAnos || 0} anos</span>
                    </div>
                    <table className="w-full">
                      <tbody>
                        ...
                        <tr className="border-t-2 border-[#0c4c45]">
                          <td className="p-3 font-bold text-[#0c4c45]">ROI</td>
                          <td className="p-3 font-bold text-[#0c4c45]">{pct(cenario1.roi)}</td>
                        </tr>
                        <tr className="bg-[#d3e9e4]">
                          <td className="p-3 font-bold text-[#083a34]">ROAS</td>
                          <td className="p-3 font-bold text-[#083a34]">{pct(cenario1.roas)}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  <div className="bg-[#e7eef5] border border-[#9bbcd3] rounded-2xl p-4 text-[13px] shadow-sm space-y-3">
                    <div className="flex items-center justify-between">
                      <h4 className="text-sm font-semibold text-[#0b3b5a]">Cenário 2 — Short Stay (5 anos)</h4>
                      <span className="text-xs text-[#125071]">Operação: 5 anos</span>
                    </div>
                    ...
                    <table className="w-full">
                      <tbody>
                        ...
                        <tr className="border-t-2 bg-[#bfd4e4]">
                          <td className="p-3 font-bold">RETORNO TOTAL</td>
                          <td className="p-3 font-bold">{brl(cenario2.retornoTotal)}</td>
                        </tr>
                        <tr className="bg-[#e4f2ef]">
                          <td className="p-3 font-bold text-[#0c4c45]">ROI</td>
                          <td className="p-3 font-bold text-[#0c4c45]">{pct(cenario2.roi)}</td>
                        </tr>
                        <tr className="bg-[#d3e9e4]">
                          <td className="p-3 font-bold text-[#083a34]">ROAS</td>
                          <td className="p-3 font-bold text-[#083a34]">{pct(cenario2.roas)}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
      ...
      <style>{`
        ...
        @media print {
          ...
          .bg-[#e4f2ef] { background-color: #e4f2ef !important; }
          .bg-[#d3e9e4] { background-color: #d3e9e4 !important; }
          .bg-[#e7eef5] { background-color: #e7eef5 !important; }
          .bg-[#d4e3ef] { background-color: #d4e3ef !important; }
          .bg-[#bfd4e4] { background-color: #bfd4e4 !important; }
        }
      `}</style>
    </div>
  );
      ...
      {items.map((item) => (
        <div
          ...
          className={`rounded-xl border p-3 text-xs space-y-1 shadow-sm transition ${
            item.destaque ? "bg-[#e4f2ef] border-[#a8d5ca] text-[#083a34]" : "bg-slate-50 border-slate-200"
          }`}
        >
          ...
          <div className={`text-[11px] ${item.destaque ? "text-[#0f6a60]" : "text-gray-600"}`}>
            {pct(item.percentual)} {item.contexto ? `do ${item.contexto}` : "do total"}
          </div>
          {item.detalhe ? (
            <div className={`text-[11px] ${item.destaque ? "text-[#0f6a60]/80" : "text-gray-500"}`}>
              {item.detalhe}
            </div>
          ) : null}
        </div>
...
function Input({ label, value, onChange, placeholder, currency = false }) {
  ...
  return (
    <label className="block">
      ...
      <input
        className="w-full px-3 py-2 rounded-xl border focus:outline-none focus:ring-2 focus:ring-[#0f6a60] bg-white"
        value={displayValue}
    ...
    <div className="space-y-2">
      <label className="block">
        ...
        <input
          ...
          className="block w-full text-xs text-gray-600 file:mr-3 file:rounded-full file:border-0 file:bg-[#e4f2ef] file:px-3 file:py-2 file:text-[#0f6a60] file:font-medium"
        />
      </label>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between rounded-xl border bg-white px-3 py-2 text-xs text-gray-600">
            ...
            <button
              ...
              className="text-[#0f6a60] font-medium hover:underline"
            >
              Remover
            </button>
          </div>
...
function KPI({ title, value, highlight, subValue }) {
  return (
    <div className={`rounded-xl border p-3 ${highlight ? "bg-[#e4f2ef] border-[#a8d5ca]" : "bg-white"}`}>
